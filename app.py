...
MODELS = {
    ...
    "image": [
        ...
        #    官方文件。所以能不能用不能靠打網關試出來——這裡的清單以文件為準。
        {
            ...
            "sizes": ["2K","1K","4K","1024*1024","1280*720","720*1280","960*1280","1280*960","960*1696","1696*960","2048*2048","4096*4096"],
            "supports_sequential": True, "sequential_max_size": "2K",
        },
        {
            "id": "wan2.7-image", "name": "萬相 2.7 Image", "group": "萬相文生圖",
            "desc": "標準文生圖", "type": "t2i", "max_n": 4,
            "sizes": ["2K","1K","1024*1024","1280*720","720*1280","960*1280","1280*960","960*1696","1696*960","2048*2048"],
            "supports_sequential": True, "sequential_max_size": "2K",
        },
        {
        ...
        # 沒有實測——實際上那條約束不適用於 /v1/images/edits 這條路徑。
        {
            ...
            "sizes": ["2K","1K","1024*1024","1280*720","720*1280","960*1280","1280*960","2048*2048"],
        },
        {
