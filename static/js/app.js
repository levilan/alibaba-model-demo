...
const _VIDEO_SEC_PRICE = {
    ...
    // ⚠️ Fast 這一列目前是**官方價，不是實際扣款價**。閘道後台配置的基準價是 $0.30/秒
    // （Google 官方 Fast 基準價的 3 倍），是刻意加成還是設定填錯尚在確認，結論出來前
    // 維持顯示官方價。確認之後這一列要改成「基準價 × 檔次倍率」的實付數字，否則這裡
    // 顯示的單價與超過 $1 的確認框都會低估約 3 倍。
